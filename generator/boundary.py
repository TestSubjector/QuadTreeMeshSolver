...
def detectOuter(hashtable, globaldata):
    ...
    while True:
        ...
        currentneighbours = getNeighbours(
            hashtable.index(currentcord) - 1, globaldata)
        ...
        if(currentstatus == 1):
            ...
            try:
                ...
                leftcord = currentneighbours[currentYCords.index(
                    max(currentYCords))]
                # print(leftcord)
            except Exception:
                None
            ...
            try:
                ...
                leftcord = currentneighbours[currentXCords.index(
                    min(currentXCords))]
                # print(leftcord)
            except Exception:
                None
            ...
            try:
                ...
                leftcord = currentnewneighbours[currentYCords.index(
                    min(currentYCords))]
                # print(leftcord)
            except Exception:
                None
            ...
            try:
                ...
                leftcord = currentnewneighbours[currentXCords.index(
                    max(currentXCords))]
                # print(leftcord)
            except Exception:
                None
            if(currentcord == biggestxy):
                globaldata = updateRight(hashtable.index(
                    biggestxy) - 1, globaldata, previouscord)
